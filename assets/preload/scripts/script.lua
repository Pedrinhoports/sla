...
function onCreate()
    ...
    setPropertyFromClass('GameOverSubstate', 'deathSoundName', 'GameOver'); --put in mods/sounds/
    setPropertyFromClass('GameOverSubstate', 'loopSoundName', 'GameOver2'); --put in mods/music/
    setPropertyFromClass('GameOverSubstate', 'endSoundName', 'GameOver2'); --put in mods/music/
	
debugPrint("Animations by Arklanday and Jason The Art Kid")


	makeLuaText('textlol', 'Song By Flares and Chart by arkly', 0, 9, 675)
    setTextSize('textlol', 20)
    setTextBorder('textlol', 2, 'ffffff')
    setTextColor('textlol', '807455')
    setTextAlignment('textlol', 'center')
    setTextFont('textlol', 'PhantomMuff Empty Letters 1.1.5.ttf')
    addLuaText('textlol')
    setObjectCamera('textlol', 'camHUD')
	setProperty('textlol.antialiasing',true)
	setProperty('vcr.antialiasing',true)
	addVCREffect('textlol',false)
end
                -- Script made by Washo789, please, if you use it or modify it, I would like you to give me credits.
				
local xx = 750; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
